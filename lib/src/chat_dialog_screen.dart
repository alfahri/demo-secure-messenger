...
class ChatScreenState extends State<ChatScreen> {
  ...
  void openCamera() async {
    ...
    var uploadImageFuture = getUploadingImageFutureNew(pickedFile);
    var imageFile;

    log("Bytes Sync : " + pickedFile.path);

    imageFile = File(pickedFile.path).readAsBytesSync();

    var decodedImage = await decodeImageFromList(imageFile);
